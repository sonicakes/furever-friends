        ...
        <img class="form-logo" src="../assets/logo.png">
          ...
          <sl-form class="form" v-on:sl-submit.prevent="addPetSubmitHandler">
            <div class="input-group">
              <sl-input label="Name" name="petName" type="text" v-on:value="this.pet.petName" placeholder="Pet Name" required></sl-input>
            </div>
            <div class="input-group">
...
export default {
    methods: {
        ...
        async getPet(){
            try {
            this.Pet = await PetAPI.getPet(Auth.currentPet.petName)      
            this.render()
            }catch(err){
        ...
        async updatePetSubmitHandler(e){
            ...
            try {
            const updatedPet = await PetAPI.updatePet(Auth.currentPet.petName, formData)      
            delete updatedPet.password        
            this.pet = updatedPet    
            Auth.currentPet = updatedPet
            this.render()
